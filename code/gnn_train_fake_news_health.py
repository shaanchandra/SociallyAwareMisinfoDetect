...
if __name__ == '__main__':
    ...
    parser.add_argument('--pos_wt', type = float, default = 0.25,
    ...
    config['loader'], config['vocab_size'], config['data'] = prepare_gnn_training(config) 
