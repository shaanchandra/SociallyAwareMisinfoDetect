...
class GCN_PreProcess():
    ...
    def create_aggregate_folder(self):
        ...
        for doc in all_docs:
            ...
            write_file = os.path.join('data', 'complete_data', 'pheme_cv', 'complete_mtl', '{}.json'.format(doc))
    ...
    def create_doc_user_folds(self):
        ...
        for fold, event in enumerate(events):
            ...
            c=0
            for split in splits:
                stance_labels_file = os.path.join('rumor_eval', 'rumoreval_crawl', '{}-key.json'.format(split))
